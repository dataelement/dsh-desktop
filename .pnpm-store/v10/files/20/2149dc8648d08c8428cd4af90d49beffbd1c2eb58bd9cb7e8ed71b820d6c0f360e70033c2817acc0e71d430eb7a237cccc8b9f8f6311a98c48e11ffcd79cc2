...
export type { ViewerOptions, FitMode, ListRenderOptions, ThumbnailRenderOptions, SearchHighlightHandle, SearchHighlightOptions, PptxViewerEventMap, PreviewInput, } from './core/Viewer';
...
export { buildPresentation, materializeAllSlideNodes, materializeSlideNodes, } from './model/Presentation';
...
export type { SerializedPresentation, SerializedSlide, SerializedNode, } from './export/serializePresentation';
export { buildTextIndex, searchPresentation, searchText } from './search/TextSearch';
export type { SearchTextKind, TextBounds, TextIndexEntry, TextIndexOptions, TextSearchOptions, TextSearchResult, } from './search/TextSearch';
...
export type { BaseNodeData, Position, Size, NodeType, PlaceholderInfo, HlinkAction, } from './model/nodes/BaseNode';
export type { ShapeNodeData, TextBody, TextParagraph, TextRun, LineEndInfo, TextBoxBounds, } from './model/nodes/ShapeNode';
