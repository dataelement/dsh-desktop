...
Generated templates, previews, package directories and build diagnostics live under ignored `.build/ppt-runtime/`. Windows packaging and native Windows PowerPoint require their own runner/device validation.
