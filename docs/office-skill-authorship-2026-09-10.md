...
六个展示案例的来源、制作方式和复现范围见 [案例说明](../packages/dsh-office/templates/README.md)。模式选择会加载对应基础 Skill，业务 Skill 由当前任务意图决定。选择展示卡片会打开预览；预览底部“做同款”会把用户确认过的案例及修订版本写入会话状态，随后由宿主注入案例说明并约束 `office_template` 使用该版本资产。
