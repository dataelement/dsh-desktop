...
it('loads the selected Word/Excel skill and retires automatic instructions when changing formats', async () => {
  ...
  expect(noticeSnapshot.content[0].text).toContain('required_business_skill: gov-doc-writing')
  expect(noticeSnapshot.content[0].text).toContain('调用 skill(name="gov-doc-writing")')
