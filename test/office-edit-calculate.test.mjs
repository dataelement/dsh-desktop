...
const word = () => pack(new Map([
  ...
  ['word/_rels/document.xml.rels', Buffer.from('<?xml version="1.0" encoding="UTF-8"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles" Target="styles.xml"/></Relationships>')],
  ['word/styles.xml', Buffer.from('<?xml version="1.0" encoding="UTF-8"?><w:styles xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:style w:type="paragraph" w:styleId="Normal"/><w:style w:type="paragraph" w:styleId="Heading1"/></w:styles>')],
  ['word/document.xml', Buffer.from('<?xml version="1.0" encoding="UTF-8"?><w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body><w:p><w:r><w:t>原始文字 保留后缀</w:t></w:r></w:p><w:p><w:r><w:t>第二段</w:t></w:r></w:p><w:sectPr/></w:body></w:document>')]
]))
const excel = () => pack(new Map([
  ...
  ['xl/workbook.xml', Buffer.from('<?xml version="1.0" encoding="UTF-8"?><workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"><sheets><sheet name="数据" sheetId="1" r:id="rId1"/></sheets></workbook>')],
  ...
  ['xl/worksheets/sheet1.xml', Buffer.from('<?xml version="1.0" encoding="UTF-8"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><sheetData><row r="1"><c r="A1" t="inlineStr"><is><t>输入</t></is></c><c r="B1" t="inlineStr"><is><t>结果</t></is></c></row><row r="2"><c r="A2"><v>3</v></c><c r="B2"><f>A2*2</f></c></row><row r="3"><c r="A3" t="inlineStr"><is><t>#标题</t></is></c><c r="B3" t="inlineStr"><is><t>=文字</t></is></c></row></sheetData></worksheet>')]
]))
